...
const (
	...
	User_DeleteOwnAccount_FullMethodName              = "/openim.user.user/deleteOwnAccount"
)
...
type UserClient interface {
	...
	// delete own account
	DeleteOwnAccount(ctx context.Context, in *DeleteOwnAccountReq, opts ...grpc.CallOption) (*DeleteOwnAccountResp, error)
}
...
func (c *userClient) DeleteOwnAccount(ctx context.Context, in *DeleteOwnAccountReq, opts ...grpc.CallOption) (*DeleteOwnAccountResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteOwnAccountResp)
	err := c.cc.Invoke(ctx, User_DeleteOwnAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	// delete own account
	DeleteOwnAccount(context.Context, *DeleteOwnAccountReq) (*DeleteOwnAccountResp, error)
...
func (UnimplementedUserServer) DeleteOwnAccount(context.Context, *DeleteOwnAccountReq) (*DeleteOwnAccountResp, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteOwnAccount not implemented")
}
...
func _User_DeleteOwnAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteOwnAccountReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).DeleteOwnAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_DeleteOwnAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).DeleteOwnAccount(ctx, req.(*DeleteOwnAccountReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "deleteOwnAccount",
			Handler:    _User_DeleteOwnAccount_Handler,
		},
	},
